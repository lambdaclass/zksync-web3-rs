...
def deploy_contract(
    ...
    print("CREATE_CONTRACT.tx", create_contract.tx)
    ...
    # print("TX_712 CONTRACT", tx_712)
    print("TX_712 ENCODED TYPE", tx_712.to_eip712_struct().encode_type())
    print("TX_712 STRUCT HASH", tx_712.to_eip712_struct().hash_struct().hex())
    # print("TX_712 SIGNATURE", signer.sign_typed_data(tx_712.to_eip712_struct()))
...
if __name__ == "__main__":
    ...
    contract_path = Path("solidity/combined.json")
