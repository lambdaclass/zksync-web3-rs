// use crate::zk_middleware::ZKMiddleware;
// use crate::zks_wallet::{DeployRequest, TransferRequest, WithdrawRequest, ZKSWallet};
...
//     let sender_private_key = "0x28a574ab2de8a00364d5dd4b07c4f2f574ef7fcc2a86a197f65abaec836d1959";
...
//     let deployer_private_key = "7726827caac94a7f9e1b160f7ea819f172f7b6f9d2a97f992c38edeab82d4110";
//     let era_provider = era_provider();
...
// //     );
// //     let value = ZKMiddleware::call(&era_provider, &call_request)
// //         .await
// //         .unwrap();
...
//     let sender_private_key = "0x28a574ab2de8a00364d5dd4b07c4f2f574ef7fcc2a86a197f65abaec836d1959";
//     let receiver_private_key = "0xe667e57a9b8aaa6709e51ff7d093f1c5b73b63f9987e4ab4aa9a5c699e024ee8";
...
//         .unwrap()
//         .with_chain_id(utils::ETH_CHAIN_ID);
//     let zk_wallet = ZKSWallet::new(
//         l2_wallet,
//         Some(l1_wallet),
//         Some(era_provider()),
